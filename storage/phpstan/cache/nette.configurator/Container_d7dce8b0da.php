...
class Container_d7dce8b0da extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_d7dce8b0da $container)
			{
	...
	public function createServiceContainer(): Container_d7dce8b0da
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'XPC_FLAGS' => '0x0',
				'TERM_SESSION_ID' => 'faf91c45-00e6-4a11-a432-ddc4c70c0ae9',
