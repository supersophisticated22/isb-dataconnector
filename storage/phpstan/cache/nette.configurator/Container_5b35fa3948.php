...
class Container_5b35fa3948 extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_5b35fa3948 $container)
			{
	...
	public function createServiceContainer(): Container_5b35fa3948
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'OLDPWD' => '/Users/fabionbaromeo/Herd/isb-presta-manager',
				'OSLogRateLimit' => '64',
				'PAGER' => 'less',
				...
				'_' => '/Users/fabionbaromeo/Herd/isb-presta-manager/./vendor/bin/phpstan',
				'LINES' => '50',
				'COLUMNS' => '80',
				'SHELL_VERBOSITY' => '0',
			],
