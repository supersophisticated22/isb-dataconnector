...
class Container_08ac4b6c8b extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_08ac4b6c8b $container)
			{
	...
	public function createServiceContainer(): Container_08ac4b6c8b
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'autoload_files' => ['bootstrap/app.php'],
			'debugMode' => true,
